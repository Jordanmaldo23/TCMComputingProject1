      ...
      <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if( $result->num_rows < 1){
            ...
            $sql = "INSERT INTO tcm_users (tcm_users_username,tcm_users_password,tcm_users_fname,tcm_users_lname,tcm_users_email,tcm_users_profile,tcm_users_admin)
            values ('".$user."','".$pass."','".$fname."','".$lname."','".$email."','".$profile."',0)";
